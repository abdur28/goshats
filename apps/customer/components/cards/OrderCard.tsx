...
import { ArrowRight2, Box, Category2, DocumentText, Reserve } from "iconsax-react-native";
...
export const OrderCard = ({ item, onPress, styleClass = "mb-4 mx-5" }: OrderCardProps) => {
  ...
  const handlePress = () => {
    if (onPress) {
      ...
      router.push({ pathname: "/orders/[id]", params: { id: item.id } } as any);
    }
  };
