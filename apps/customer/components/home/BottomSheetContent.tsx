...
export default function BottomSheetContent({
  ...
  return (
    ...
    >
      ...
      {/* Parcels Card */}
      <View className="bg-indigo-500 rounded-[28px] p-5 mb-4 shadow-sm overflow-hidden relative">
        <Text className="text-lg font-sans-bold text-white z-10 relative">
          Parcels
        </Text>
        <Text className="text-sm font-sans text-gray-100 mt-1 mb-5 leading-5 w-[60%] z-10 relative">
      ...
      {/* Document Card */}
      <View className="bg-primary rounded-[28px] p-5 mb-10 shadow-sm overflow-hidden relative">
        <Text className="text-lg font-sans-bold text-white z-10 relative">
          Documents
        </Text>
        <Text className="text-sm font-sans text-gray-100 mt-1 mb-5 leading-5 w-[60%] z-10 relative">
